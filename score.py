...
args.add_argument("--bin_path", type = str, default="bin/perceptron-no-ghb-no-srrip-1core",help = "bin_path")
args.add_argument("--traces_dir_path", type = str,default="traces", help = "traces_dir_path")
